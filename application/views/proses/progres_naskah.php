...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <h5 class="card-title">JOB BARU DARI PRODUKSI</h5>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
...
<button type="submit" id="cari" name="cari" value=TRUE class="btn btn-success btn-sm mx-1">Detail</button>
            ...
            <div class="card mb-2">
                <div class="card-body">
                    <h5 class="card-title">JOB PROSES</h5>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>';
                                    echo '<div class="row">';
                                    echo '                             
                                <button id="tombolMulai" data-status="TUNDA" data-naskah_rencana_produksi_id="' . $naskah_rencana_produksi_id . '" data-nojob="' . $nojob . '" data-nama_objek_kerja="' . $nama_objek_kerja . '" data-nama_level_kerja="' . $nama_level_kerja . '" data-toggle="modal" data-target="#mulaiModal" type="button" class="btn btn-primary btn-sm mx-1">Tunda</button>
                                <button ';
                                    if ($mulai_real == '') {
                                        echo 'disabled';
                                    }

                                    echo ' id="tombolSelesai" data-status="SELESAI" data-naskah_rencana_produksi_id="' . $naskah_rencana_produksi_id . '" data-nojob="' . $nojob . '" data-nama_objek_kerja="' . $nama_objek_kerja . '" data-nama_level_kerja="' . $nama_level_kerja . '" data-toggle="modal" data-target="#selesaiModal" type="button" class="btn btn-danger btn-sm mx-1">Selesai</button>';
                                    echo '<form method="post" action="' . base_url('laporan/job') . '">
                                    <input type="hidden" id="nojob" name="nojob" value="' . $nojob . '">
<button type="submit" id="cari" name="cari" value=TRUE class="btn btn-success btn-sm mx-1">Detail</button>
                                </form>';
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title">JOB TUNDA</h5>
                    <table class="table">
                        <thead>
                            <tr>
                                <th scope="col">#</th>
                            ...
                            <tr>
                               ...
                               <td>';
                                ...
                                <button ';
                                    ...
                                    echo ' id="tombolMulai" data-status="LANJUT" data-naskah_rencana_produksi_id="' . $naskah_rencana_produksi_id . '" data-nojob="' . $nojob . '" data-nama_objek_kerja="' . $nama_objek_kerja . '" data-nama_level_kerja="' . $nama_level_kerja . '" data-toggle="modal" data-target="#mulaiModal" type="button" class="btn btn-primary btn-sm mx-1">Lanjut</button>
                                <button ';
                                    if ($mulai_real == '') {
                                        echo 'disabled';
                                    }
...
<div class="modal fade" id="selesaiModal" tabindex="-1" aria-labelledby="selesaiModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="<?php echo base_url('proses/progres_naskah'); ?>">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="halaman" class="form-control" id="naskah_selesai_jumlah_halaman">
                        </div>
                    </div>
                    <input type="hidden" name="status" id="status">
                    <input type="hidden" name="nojob" id="nojob">
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Batal</button>
                <button type="submit" id="tombol_selesai" name="tombol_selesai" value=TRUE class="btn btn-danger disabled" onclick="return false">OK</button>
            </div>
            </form>
        </div>
    </div>
