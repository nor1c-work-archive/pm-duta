...
<div class="container-fluid">
    ...
    <div class="row">
        ...
        <div class="col">
            ...
            <div class="card mb-1">
                <div class="card-body">
                    <form method="post" action="<?php echo base_url('laporan/buku_masuk'); ?>">
                        <div class="form-group row">
                            <label for="gudan_id" class="col-sm-2 col-form-label">Gudang</label>
                            <div class="col-sm-3">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input id="dari_tgl" name="dari_tgl" value="<?php echo $buku_masuk['dari_tgl']; ?>" />
                                <script>
                                    $('#dari_tgl').datepicker({
                            ...
                            <div class="col-sm-3">
                                <input id="sampai_tgl" name="sampai_tgl" value="<?php echo $buku_masuk['sampai_tgl']; ?>" />
                                <script>
